...
const NewCustomerForm = (props = { onSubmit: null, onHide: null, show: false }) => {
    ...
    const handleSubmit = () => {
        let builder = formValidator.validateNewCustomer(values, {}, setError)
        if (!builder) {
            return
        }
        // submit
    ...
    return (
        <Dialog header="New Customer Acccount" visible={props.show} modal onHide={() => props.onHide()} style={{ width: "45vw" }}>
            <div>
                <div className="mb-4"><h6>Customer Information</h6></div>
                ...
                <div className="row">
                    <div className="col-lg-6">
                        <div className="p-field mb-2">
                            <label htmlFor="city">Customer City*</label><br />
