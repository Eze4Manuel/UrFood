...
import { EditPassword } from './EditCustomerForm';
import CustomersUserDetail from './CustomerUserDetail';
...
const CustomerUserData = ({ data, show, onHide, onDeleted, onUpdated }) => {
    ...
    const deleteAccount = async () => {
        ...
        if (reqData.status === 'ok') {
            ...
            onHide()
            helpers.alert({ notifications: notify, icon: 'success', color: 'green', message: 'Customers deleted' })
        }
    }
    ...
    return (
        <Dialog closeOnEscape header={'Customer'} visible={show} modal onHide={() => onHide()} style={{ width: "70vw" }}>
            <div className="partner-info__ctn">
                ...
                <div className="row">
                    <div className="col-7 mt-5">
                        ...
                        <CustomersUserDetail data={values} />
                    </div>
                    <div className="col-5">
                        
                        {/* EDIT Customers PROFILE */}
                        <EditCustomers onUpdated={(data) => setValues(data)} onHide={() => onCancelProfileEdit()} data={values} show={showPartner} />
                        {/* EDIT PASSWORD */}
...
export default CustomerUserData
