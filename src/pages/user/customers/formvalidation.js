...
formValidator.validateCustomerUpdate = (form, values, builder, data, setError) => {
   setError("");

   //validate the first_name
   if (form.first_name !== values.first_name) {
      if (!form.first_name) {
    ...
    if (form.last_name !== values.last_name) {
      if (!form.last_name) {
...
formValidator.validateNewCustomer = (form, builder, setError) => {
   setError("")
